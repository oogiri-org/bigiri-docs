...
> ユーザーマニュアルはbǃgǃrǃ([https://bigiri.oogiri.org](https://bigiri.oogiri.org))の**更新情報**と**画面構成**を入力データとして、記名されている各**AI**が生成しました。
> 生成された内容は人間によって校閲されておらず嘘・大げさ・まぎらわしい部分を含んでいることがあります。
