    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'bǃgǃrǃ ユーザーマニュアル (by Anthropic Claude Sonnet)', link: '/user-manual/user-manual-by-claude-sonnet' },
          { text: 'bǃgǃrǃ ユーザーマニュアル (by OpenAI Codex with GPT-5-Codex)', link: '/user-manual/user-manual-by-gpt-5' },
          { text: 'bǃgǃrǃ ユーザーマニュアル (by GitHub Copilot with GPT-5 mini)', link: '/user-manual/user-manual-by-copilot' },
