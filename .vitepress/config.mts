...
export default defineConfig({
  ...
  themeConfig: {
    ...
    logo: { src: 'https://cdn.jsdelivr.net/gh/googlefonts/noto-emoji@main/3D/png/512/emoji_u1f984.png', alt: 'icon' },
    lastUpdated: {
      formatOptions: {
        year: 'numeric',
        month: 'long',
  ...
  */
  head: [
    ['link', { rel: 'shortcut icon', href: 'https://cdn.jsdelivr.net/gh/googlefonts/noto-emoji@main/3D/png/512/emoji_u1f984.png' }],
    ['link', { rel: 'apple-touch-icon', href: 'https://cdn.jsdelivr.net/gh/googlefonts/noto-emoji@main/3D/png/512/emoji_u1f984.png' }],
    ['link', { rel: 'icon', href: 'https://cdn.jsdelivr.net/gh/googlefonts/noto-emoji@main/3D/png/512/emoji_u1f984.png' }],
  ],
  markdown: {
    anchor: {
